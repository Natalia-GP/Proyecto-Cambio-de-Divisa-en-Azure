...
namespace Negocio
{
    internal class Json
    {
        ...
        public class JsonCurrencyLayer
        {
        ...
        public class Quotes
        {
            ...
            public float USDSKK { get; set; }
            public float USDSIT { get; set; }
            public float USDESP { get; set; }
